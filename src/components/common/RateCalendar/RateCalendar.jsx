...
const DownloadRateCalendarPDF = dynamic(
  () =>
    import(
      "@/components/common/DownloadRateCalendarPDF/DownloadRateCalendarPDF"
    ),
  { ssr: false }
);
export default function RateCalendar() {
  ...
  const getRatesForDate = useCallback(
    (calendarDate, company, location, commodity) => {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Track and visualize rate changes across companies and commodities.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            ...
            >
              ...
              {availableCommodities.map((com, idx) => (
          ...
          <AnimatePresence>
            {rateData
              ...
              .map(({ company, location, commodity }) => (
                <motion.div
                    ...
                    <div className="w-full lg:w-1/2">
                      <Calendar
                        ...
                        tileContent={({ date }) => {
                          ...
                          return (
                            <div
                              className={`rounded text-white text-[10px] px-1 mt-1 ${bg}`}
                            >
                              {info.rate}
                            </div>
                          );
