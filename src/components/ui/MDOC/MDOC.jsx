...
import useMDOCRates from "@/hooks/MDOC/useMDOCRates";
import { exportToExcel, exportToPDF } from "@/utils/mdoc/exportMDOC";
...
export default function MDOC() {
  ...
  const { rows, loading, commodities } = useMDOCRates(date, search);
