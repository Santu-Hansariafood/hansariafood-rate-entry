...
import useSoyaRates from "@/hooks/Soya/useSoyaRates";
import { exportToExcel, exportToPDF } from "@/utils/soya/exportSoya";
...
export default function Soya() {
  const [search, setSearch] = useState("");
  const [date, setDate] = useState(todayISO);

  const { rows, loading, commodities } = useSoyaRates(date, search);
