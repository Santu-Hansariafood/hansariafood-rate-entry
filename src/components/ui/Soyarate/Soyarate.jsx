...
const SoyaNotificationsPanel = dynamic(() =>
  import("./SoyaNotificationsPanel/SoyaNotificationsPanel")
);
...
export default function Soyarate() {
  ...
  const { notifications, refreshNotifications } = useRateNotifications("Soya");
        ...
        {showRateList && (
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="w-full lg:w-1/4 h-[80vh] sticky top-4">
              <SoyaNotificationsPanel notifications={notifications} />
            </div>
          </div>
        )}
