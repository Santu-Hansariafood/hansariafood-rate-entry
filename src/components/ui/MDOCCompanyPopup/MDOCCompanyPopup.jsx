                    ...
                    {rates[loc]?.map((item, index) => {
                      ...
                      return (
                        <div key={index} className={`p-5 rounded-xl border transition-all ${
                          isEditing ? 'border-blue-200 bg-blue-50/10' : 'border-gray-100 bg-white'
                        }`}>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex flex-col gap-1">
                                <label className="text-[10px] font-bold uppercase text-blue-600">Temp Rate (Today)</label>
                                <div className="flex items-center gap-1 border-b border-blue-200 pb-1">
                                  ...
                                  <input
                                    ...
                                    className="w-full bg-transparent font-bold text-lg outline-none text-blue-700"
                                    placeholder="0"
                                  />
                                </div>
                              </div>
                            ...
                            <div className="space-y-4">
                              <div className="flex flex-col gap-1.5">
                                ...
                                <select
                                  ...
                                  className="w-full px-3 py-2 text-sm font-medium rounded-lg border border-gray-200 bg-white focus:border-blue-500 outline-none"
                                >
                              ...
                              <div className="flex flex-col gap-1.5">
                                ...
                                <div className="flex items-center justify-between p-3 rounded-lg bg-blue-50 border border-blue-100">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[10px] font-bold text-blue-800 uppercase">Freight</span>
                                  </div>
