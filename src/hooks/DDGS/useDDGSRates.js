...
export default function useDDGSRates(date, search) {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const companyRes = await axiosInstance.get("/ddgscompany");
      ...
      console.error(err);
      toast.error("Failed to load DDGS rates");
    } finally {
      setLoading(false);
    }
  }, [date]);
